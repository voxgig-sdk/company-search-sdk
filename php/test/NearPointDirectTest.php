...
class NearPointDirectTest extends TestCase
{
    public function test_direct_list_near_point(): void
    {
        $setup = near_point_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-near_point", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
