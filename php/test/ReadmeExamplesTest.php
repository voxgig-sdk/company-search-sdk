...
// CompanySearch SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CompanySearchSDK::test)
...
{
    private const SDK_CLASS = 'CompanySearchSDK';
    ...
    private const SDK_BASE = 'companysearch_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../companysearch_sdk.php';
