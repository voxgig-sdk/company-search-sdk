...
class NearPointEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = CompanySearchSDK::test($seed, null);
        $seen = iterator_to_array($base->NearPoint(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->NearPoint(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set COMPANY_SEARCH_TEST_NEAR_POINT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function near_point_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("COMPANY_SEARCH_TEST_NEAR_POINT_ENTID");
