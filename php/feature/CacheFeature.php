...
// CompanySearch SDK cache feature
...
class CompanySearchCacheFeature extends CompanySearchBaseFeature
{
    ...
    private function _through(CompanySearchContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
