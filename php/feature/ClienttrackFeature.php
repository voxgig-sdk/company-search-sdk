...
// CompanySearch SDK clienttrack feature
...
class CompanySearchClienttrackFeature extends CompanySearchBaseFeature
{
    ...
    public function PostConstruct(CompanySearchContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CompanySearch-SDK';
