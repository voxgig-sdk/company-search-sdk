...
// CompanySearch SDK debug feature
...
class CompanySearchDebugFeature extends CompanySearchBaseFeature
{
    ...
    private function _finish(CompanySearchContext $ctx, bool $ok): void
    {
