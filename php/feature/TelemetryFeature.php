...
// CompanySearch SDK telemetry feature
...
class CompanySearchTelemetryFeature extends CompanySearchBaseFeature
{
    ...
    private function _close(CompanySearchContext $ctx, bool $ok): void
    {
