...
// CompanySearch SDK utility type

class CompanySearchUtility
{
    ...
    public static function copy(CompanySearchUtility $src): CompanySearchUtility
    {
        $u = new CompanySearchUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
