...
The PHP SDK for the CompanySearch API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->NearPoint(null)->list(null, null);
...
[$result, $err] = $client->CompanySearch(null)->load(
    ["id" => "test01"], null
);
