...
from companysearch_sdk.utility import register

# Load features
from companysearch_sdk.feature.base_feature import CompanySearchBaseFeature
from companysearch_sdk.features import _has_feature, _make_feature
...
class CompanySearchSDK:
    ...
    def get_utility(self):
        return CompanySearchUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CompanySearchSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def NearPoint(self, data=None) -> "NearPointEntity":
        ...
        from companysearch_sdk.entity.near_point_entity import NearPointEntity
        return NearPointEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from companysearch_sdk.entity.search_entity import SearchEntity
