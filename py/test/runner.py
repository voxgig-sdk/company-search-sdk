...
class CompanySearchTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CompanySearchTestRunner.getenv("COMPANYSEARCH_TEST_LIVE")
        override = CompanySearchTestRunner.getenv("COMPANYSEARCH_TEST_OVERRIDE")
        ...
        explain = CompanySearchTestRunner.getenv("COMPANYSEARCH_TEST_EXPLAIN")
