# CompanySearch SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CompanySearchSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CompanySearchSDK(...) and CompanySearchSDK.test(...) become
#      CompanySearchSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "companysearch_sdk"
_SDK_CLASS = "CompanySearchSDK"
