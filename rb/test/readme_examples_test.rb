...
#      offline in seeded test mode (CompanySearchSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CompanySearch_sdk.rb")
  SDK_CLASS = "CompanySearchSDK"
