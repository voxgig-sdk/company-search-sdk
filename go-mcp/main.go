// Command CompanySearch-mcp is an MCP server exposing the CompanySearch
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CompanySearch_list  — list records of an entity
//	CompanySearch_load  — load a single record of an entity
//
