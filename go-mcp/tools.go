...
type Args struct {
	Entity string         `json:"entity" jsonschema:"near_point | search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CompanySearchSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "company-search_list",
		Description: "List records from CompanySearch. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "company-search_load",
		Description: "Load a single record from CompanySearch. " +
...
func runOp(client *sdk.CompanySearchSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CompanySearchSDK, name string) (sdk.CompanySearchEntity, error) {
	switch strings.ToLower(name) {
	case "near_point":
		return client.NearPoint(nil), nil
	case "search":
