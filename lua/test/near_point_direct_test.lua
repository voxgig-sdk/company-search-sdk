...
describe("NearPointDirect", function()
  it("should direct-list-near_point", function()
    local setup = near_point_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-near_point", setup.live and "live" or "unit")
...
function near_point_direct_setup(mockres)
