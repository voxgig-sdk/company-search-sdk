...
function runner.env_override(m)
  local live = runner.getenv("COMPANY_SEARCH_TEST_LIVE")
  local override = runner.getenv("COMPANY_SEARCH_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("COMPANY_SEARCH_TEST_EXPLAIN")
