...
function runner.env_override(m)
  local live = runner.getenv("COMPANYSEARCH_TEST_LIVE")
  local override = runner.getenv("COMPANYSEARCH_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("COMPANYSEARCH_TEST_EXPLAIN")
