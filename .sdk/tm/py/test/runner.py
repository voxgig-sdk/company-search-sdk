...
class CompanySearchTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CompanySearchTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CompanySearchTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CompanySearchTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
