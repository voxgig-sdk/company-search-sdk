...
class CompanySearchTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CompanySearchTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = CompanySearchTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = CompanySearchTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
