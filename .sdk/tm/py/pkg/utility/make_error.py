# CompanySearch SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, CompanySearchError):
        errmsg = err.msg
    ...
    msg = "CompanySearchSDK: " + opname + ": " + errmsg
    ...
    sdk_err = CompanySearchError("", msg, ctx)
