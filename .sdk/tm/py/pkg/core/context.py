...
from projectname_sdk.core.control import CompanySearchControl
...
class CompanySearchContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CompanySearchControl()
        ...
        if isinstance(sp, CompanySearchSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CompanySearchResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CompanySearchResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CompanySearchError(code, msg, self)
