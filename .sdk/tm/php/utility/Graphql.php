...
// CompanySearch SDK utility: graphql
//
...
class CompanySearchGraphql
{
    ...
    // equivalent.
    public static function body(CompanySearchContext $ctx): mixed
    {
    ...
    public static function errors(CompanySearchContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
