...
// CompanySearch SDK utility: fetcher

class CompanySearchFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CompanySearchSDK/1.0)';
    ...
    public static function call(CompanySearchContext $ctx, string $fullurl, array $fetchdef): array
    {
