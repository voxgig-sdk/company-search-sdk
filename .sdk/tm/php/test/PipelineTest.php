...
// CompanySearch SDK pipeline test
//
...
{
    private static function utility(): CompanySearchUtility
    {
        return new CompanySearchUtility();
    }
    ...
    private static function ctx(array $over = []): CompanySearchContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CompanySearchContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CompanySearchOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CompanySearchError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CompanySearchOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CompanySearchMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CompanySearchOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CompanySearchMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CompanySearchOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CompanySearchMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CompanySearchSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CompanySearchMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = CompanySearchMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CompanySearchSpec([]),
            'response' => null,
            'result' => new CompanySearchResult([]),
        ]);
        [, $err] = CompanySearchMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CompanySearchSpec(['step' => 's']),
            'response' => new CompanySearchResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CompanySearchResult([]),
        ]);
        [, $err] = CompanySearchMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CompanySearchSpec(['step' => 's']),
            'response' => new CompanySearchResponse(self::resp(200, ['v' => 1])),
            'result' => new CompanySearchResult([]),
        ]);
        [, $err] = CompanySearchMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CompanySearchSpec(['step' => 's']),
            'response' => new CompanySearchResponse(self::resp(200, ['v' => 2])),
            'result' => new CompanySearchResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CompanySearchMakeResponse::call($ctx);
    ...
    {
        $preset = new CompanySearchResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CompanySearchSpec([]),
            'response' => new CompanySearchResponse([]),
            'result' => new CompanySearchResult([]),
        ...
        [$got, $err] = CompanySearchMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CompanySearchResult([])]);
        [, $err] = CompanySearchMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CompanySearchSpec([]), 'result' => null]);
        [, $err] = CompanySearchMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CompanySearchSpec(['step' => 's']),
            'result' => new CompanySearchResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CompanySearchOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CompanySearchMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CompanySearchSpec(['step' => 's']),
            'result' => new CompanySearchResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CompanySearchOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CompanySearchMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CompanySearchResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CompanySearchSpec([]),
            'result' => new CompanySearchResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CompanySearchMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CompanySearchMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CompanySearchError('boom', 'boom');
        $utility->fetcher = function (CompanySearchContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CompanySearchSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CompanySearchMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CompanySearchContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CompanySearchMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CompanySearchResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        CompanySearchMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CompanySearchContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CompanySearchSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CompanySearchMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CompanySearchResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CompanySearchSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CompanySearchMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CompanySearchMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CompanySearchMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CompanySearchResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CompanySearchDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CompanySearchResult(['ok' => false])]);
        $this->expectException(CompanySearchError::class);
        CompanySearchDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CompanySearchResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CompanySearchMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CompanySearchMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CompanySearchBaseFeature();
        $b = new CompanySearchBaseFeature();
        CompanySearchFeatureAdd::call($ctx, $a);
        CompanySearchFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CompanySearchBaseFeature
    {
        $f = new CompanySearchBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CompanySearchFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CompanySearchContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CompanySearchSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CompanySearchPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        CompanySearchPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CompanySearchResponse(['headers' => null]),
            'result' => new CompanySearchResult([]),
        ]);
        CompanySearchResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        CompanySearchResultBody::call($ctx);
