...
// CompanySearch SDK streaming feature
...
class CompanySearchStreamingFeature extends CompanySearchBaseFeature
{
    ...
    private function _iterate(CompanySearchResult $result): \Generator
    {
    ...
    private function _streamable(CompanySearchContext $ctx): bool
    {
