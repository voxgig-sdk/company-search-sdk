...
// CompanySearch SDK netsim feature
...
class CompanySearchNetsimFeature extends CompanySearchBaseFeature
{
    ...
    private function _simulate(CompanySearchContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CompanySearchContext $ctx, array $applied): void
    {
        $client = $this->client;
