...
// CompanySearch SDK metrics feature
...
class CompanySearchMetricsFeature extends CompanySearchBaseFeature
{
    ...
    private function _record(CompanySearchContext $ctx, bool $ok): void
    {
