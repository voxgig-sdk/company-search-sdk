...
// CompanySearch SDK audit feature
...
class CompanySearchAuditFeature extends CompanySearchBaseFeature
{
    ...
    private function _emit(CompanySearchContext $ctx, string $outcome): void
    {
