...
// CompanySearch SDK proxy feature
...
class CompanySearchProxyFeature extends CompanySearchBaseFeature
{
    ...
    public function init(CompanySearchContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CompanySearchContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
