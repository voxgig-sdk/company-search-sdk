...
// CompanySearch SDK ratelimit feature
...
class CompanySearchRatelimitFeature extends CompanySearchBaseFeature
{
    ...
    private function _acquire(CompanySearchContext $ctx): void
    {
    ...
    private function _track(CompanySearchContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
