...
// CompanySearch SDK rbac feature
...
class CompanySearchRbacFeature extends CompanySearchBaseFeature
{
    ...
    private function _required(CompanySearchContext $ctx): ?string
    {
    ...
    private function _reject(CompanySearchContext $ctx, string $required): void
    {
    ...
    private function _track(CompanySearchContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
