...
// CompanySearch SDK idempotency feature
...
class CompanySearchIdempotencyFeature extends CompanySearchBaseFeature
{
    ...
    private function _mutating(CompanySearchContext $ctx): bool
    {
