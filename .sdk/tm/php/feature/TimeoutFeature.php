...
// CompanySearch SDK timeout feature
...
class CompanySearchTimeoutFeature extends CompanySearchBaseFeature
{
    ...
    private function _with_timeout(CompanySearchContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CompanySearchContext $_ctx, float $ms): void
    {
        $client = $this->client;
