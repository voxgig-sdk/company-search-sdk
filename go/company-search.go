...
// instead of `sdk.NewCompanySearchSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *CompanySearchSDK  { return NewCompanySearchSDK(nil) }
func Test() *CompanySearchSDK { return TestSDK(nil, nil) }
