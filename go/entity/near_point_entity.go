...
func NewNearPointEntity(client *core.CompanySearchSDK, entopts map[string]any) *NearPointEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NearPointEntity) GetName() string { return e.name }
...
func (e *NearPointEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NearPointEntity) Deleted() bool {
	return e.deleted
}


func (e *NearPointEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNearPointEntity(e.client, opts)
}

func (e *NearPointEntity) Data(args ...any) any {
...
func (e *NearPointEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an NearPoint; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NearPointEntity) DataTyped(data ...NearPoint) NearPoint {
	if len(data) > 0 {
		return typedFrom[NearPoint](e.Data(asMap(data[0])))
	}
	return typedFrom[NearPoint](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through NearPoint (all fields
// optional at the wire level).
func (e *NearPointEntity) MatchTyped(match ...NearPoint) NearPoint {
	if len(match) > 0 {
		return typedFrom[NearPoint](e.Match(asMap(match[0])))
	}
	return typedFrom[NearPoint](e.Match())
}
...
func (e *NearPointEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NearPointEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *NearPointEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NearPointListMatch and returns []NearPoint. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *NearPointEntity) ListTyped(reqmatch NearPointListMatch, ctrl map[string]any) ([]NearPoint, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[NearPoint](res), nil
}



func (e *NearPointEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NearPointEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NearPointEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NearPointEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
