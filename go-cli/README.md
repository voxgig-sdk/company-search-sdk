...
AQL-driven CLI and REPL for the CompanySearch SDK. Positional arguments are
...
./company-search-cli load 1 near_point
./company-search-cli load '{id:1}' near_point
