...
func registerSDKWords(r *eng.Registry, client *sdk.CompanySearchSDK) {
...
func runOp(client *sdk.CompanySearchSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
