...
describe('exists', async () => {
  ...
  //
  // CompanySearchSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof CompanySearchSDK, true,
      'CompanySearchSDK.test() must return a client synchronously')
  })
