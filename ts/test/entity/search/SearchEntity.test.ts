...
describe('SearchEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    if (setup.syntheticOnly) {
      t.skip('live entity test uses synthetic IDs from fixture — set COMPANY_SEARCH_TEST_SEARCH_ENTID JSON to run live')
      return
    }
...
function basicSetup(extra?: any) {
  ...
  const idmapEnvVal = process.env['COMPANY_SEARCH_TEST_SEARCH_ENTID']
  ...
  idmap = env['COMPANY_SEARCH_TEST_SEARCH_ENTID']
